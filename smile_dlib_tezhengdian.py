# -*- coding: utf-8 -*-
"""
Created on Tue Dec  7 14:52:53 2021
...
# 读取图像所在的路径
path_images_with_smiles = "D:/myworkspace/JupyterNotebook/Smile/database/smile/"
path_images_no_smiles = "D:/myworkspace/JupyterNotebook/Smile/database/no_smile/"
...
# 存储提取特征数据的 CSV 的路径
path_csv = "D:/myworkspace/JupyterNotebook/Smile/data/data_csvs/"


# write the features into CSV
def write_into_CSV():
    with open(path_csv+"data1.csv", "w", newline="") as csvfile:
